// LEAST COMMON ANCESTOR FOR A BINARY TREE.cpp : FIND THE LEAST COMMON ANCESTOR FOR A BINARY TREE(NOT A BST)
//
...
NODE* find_least_common_ancestor(NODE *node1, NODE *node2)
{
	NODE *root = node1;
	while(root!=NULL)
	{
